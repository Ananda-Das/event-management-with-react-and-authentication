const Footer = () => {
  return (
    <div>
      <footer className="footer p-10 bg-neutral text-neutral-content px-14 mt-14">
        <nav>
          <header className="footer-title">Our Services</header>
          <a className="link link-hover">About Us</a>
          <a className="link link-hover">Services</a>
          <a className="link link-hover">Blog</a>
          <a className="link link-hover">Spekers</a>
        </nav>
        <nav>
          <form>
            ...
            <fieldset className="form-control w-80">
              ...
              <div className="relative">
                ...
                <button className="btn bg-[#ce1446] text-white absolute top-0 right-0 rounded-l-none font-bold">Subscribe</button>
              </div>
            </fieldset>
          </form>
        </nav>
