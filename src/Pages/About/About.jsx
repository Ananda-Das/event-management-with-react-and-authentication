  ...
  return (
    <div>
      ...
      <div className="w-11/12 mx-auto mt-14">
        <div className="flex lg:flex-row flex-col gap-16 items-center justify-around shadow-2xl p-5">
          <div>
        ...
        <div className="flex flex-col lg:flex-row-reverse gap-16 items-center justify-around shadow-2xl p-5 mt-5">
          <div>
            <h2 className="text-3xl font-bold uppercase text-[#ce1446] mb-5  text-center lg:text-right">Our Story</h2>
            <p className="text-xl ml-5 text-center lg:text-right">
